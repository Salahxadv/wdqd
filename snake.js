...
window.onload = function() {
    ...
    var images = [];
    var tileimage;
    var appleimage; // New variable for the apple image
    ...
    function init() {
        // Load images
        images = loadImages(["snake-graphics.png", "1.jpg"]);
        tileimage = images[0];
        appleimage = images[1]; // Assign the apple image
        ...
        for (var i=0; i<level.columns; i++) {
            for (var j=0; j<level.rows; j++) {
                ...
                if (tile == 0) {
                    ...
                    // Draw the apple image (using the full 1.png image)
                    context.drawImage(appleimage, 0, 0, appleimage.width, appleimage.height, tilex, tiley, level.tilewidth, level.tileheight);
                }
            }
        }
    }
